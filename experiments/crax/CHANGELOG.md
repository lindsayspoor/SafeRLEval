...
### 2025-08-12
- Added a new `Research Questions` section to `XXXX-5/6873d12a507dfe00bbdae442/chapters/1_introduction.tex` before the Methodology section.
  - Rationale: Address missing research questions and clarify the XXXX-5' guiding inquiries.
- Created a timestamped backup: `XXXX-5/6873d12a507dfe00bbdae442/chapters/1_introduction_backup_2025-08-12_1.tex`.


### 2025-08-12
- Added `XXXX-5/slides/main.py` to generate slides using Deckbuilder (python-pptx backend) with CLI for Markdown/JSON inputs.
  - Reason: Begin XXXX-5 slide workflow integrated with Deckbuilder as requested.
- Created starter markdown deck `XXXX-5/slides/presentation.md` with common sections (Motivation, Problem, Contributions, Results).
