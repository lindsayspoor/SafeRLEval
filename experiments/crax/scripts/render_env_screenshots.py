...
def main(output_dir: str = "XXXX-5/assets/env_screenshots", width: int = 640, height: int = 480):
...
if __name__ == "__main__":
    out_dir = sys.argv[1] if len(sys.argv) > 1 else "XXXX-5/assets/env_screenshots"
    main(out_dir)
